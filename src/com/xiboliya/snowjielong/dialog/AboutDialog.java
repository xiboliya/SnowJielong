...
public class AboutDialog extends BaseDialog implements ActionListener {
  ...
  private static final int LINES = 9; // 显示标签的行数
  ...
  private void initLabelList() {
    String strGithubCode = "https://github.com/xiboliya/SnowJielong";
    String strGitee = "https://gitee.com/xiboliya/snowjielong";
    String strGitCode = "https://gitcode.net/chenzhengfeng/snowjielong";
    String[] arrStrLabel = new String[] {
        ...
        "<html>Gitee：<a href='" + strGitee + "'>" + strGitee + "</a></html>",
    ...
    this.addLinkByIndex(6, strGitee);
